...
3.  Erick Hadi: Web scraping, Analysis, Database, Write Up
...
-   **Code Sharing**: We will use GitHub as our version control system for sharing and collaborating on code.
    GitHub will help us manage contributions, track changes, and work seamlessly on the codebase.
...
However, due to an incomplete data set in Glassdoor, we decided to use Linkedin dataset.
...
Below are some of the things we did to tidy our dataframe:
